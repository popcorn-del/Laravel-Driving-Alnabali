...
(function(g) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(e) { return g(e, window, document) }) : "object" === typeof exports ? module.exports = function(e, f) {
        e || (e = window);
...
(function(e) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(k) { return e(k, window, document) }) : "object" === typeof exports ? module.exports = function(k, i) { k || (k = window); if (!i || !i.fn.dataTable) i = require("datatables.net")(k, i).$; return e(i, k, k.document) } : e(jQuery, window, document) })(function(e, k, i, o) {
    ...
    e.extend(m.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.editor) {
                ...
                e(b.table().body()).on("dblclick" +
                    d, "th, td",
                    function(d) {!1 !== a.s.enable && b.cell(this).any() && (a.s.lastFocus && this !== a.s.lastFocus.cell.node() || a._editor(null, d, !0)) });
            ...
            b.on("draw" + d, function(d) {
                ...
                if (!a.s.focusDraw &&
                    ...
                    var c = a.s.lastFocus.relative,
                        f = b.page.info(),
                        e = c.row + f.start;
                    0 !== f.recordsDisplay && (e >= f.recordsDisplay && (e = f.recordsDisplay - 1), a._focus(e, c.column, !0, d))
                }
            });
        ...
        _focus: function(a, b, c, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, j.one("draw", function() {
                    ...
                    if (c === o || !0 === c) this._scroll(e(k), e(i.body), h, "offset"), c = j.table().body().parentNode, c !== j.table().header().parentNode && (c = e(c.parentNode), this._scroll(c, c, h, "position"));
                    ...
                    if (d)
                        if (this.s.dt.cell(d.node).any()) {
                            ...
                            if (!(this.c.keys && -1 === e.inArray(a.keyCode, this.c.keys))) switch (a.keyCode) {
                                ...
                                case 33:
                                case 34:
                                    c && !f && (a.preventDefault(), d.page(33 === a.keyCode ?
        ...
        _scroll: function(a, b, c, d) {
            ...
            f.left + g > n + a && g < a && b.scrollLeft(f.left +
                g - a)
        },
        _shift: function(a, b, c) {
            ...
            if (g) {
                ...
                0 <= i && i < j && -1 !== e.inArray(f, h) ? (a && a.preventDefault(), this._focus(i, f, !0, a)) : !c ||
                    !this.c.blurable ? a && a.preventDefault() : this._blur()
            }
        },
        _tabInput: function() {
            var a = this,
                b = this.s.dt,
                c = null !== this.c.tabIndex ? this.c.tabIndex : b.settings()[0].iTabIndex; - 1 != c && (this.s.tabInput || (c = e('<div><input type="text" tabindex="' + c + '"/></div>').css({ position: "absolute", height: 1, width: 0, overflow: "hidden" }), c.children().on("focus", function(c) {
                var e = b.cell(":eq(0)", a._columns(), { page: "current" });
                e.any() && a._focus(e, null, !0, c)
            }), this.s.tabInput = c), (c = this.s.dt.cell(":eq(0)", "0:visible", {
                page: "current",
                order: "current"
    ...
    l.Api.register("keys.move()",
        function(a) { return this.iterator("table", function(b) { b.keytable && b.keytable._shift(null, a, !1) }) });
    l.ext.selector.cell.push(function(a, b, c) {
        var b = b.focused,
            a = a.keytable,
            d = [];
        if (!a || b === o) return c;
        for (var e = 0, i = c.length; e < i; e++)(!0 === b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]);
        return d
    });
