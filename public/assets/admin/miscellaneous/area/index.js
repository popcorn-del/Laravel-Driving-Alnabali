$(document).ready(function () {
    ...
    $(".reset-btn").click(function () {
        ...
        $('#custom-form').bootstrapValidator({
            excluded: [':disabled']
        });
        $('#custom-form').bootstrapValidator('resetForm', true);
        $("#custom-form").trigger("reset");
        if (document.getElementById("cityTitle").innerHTML != "ADD AREA") {
            initForm(id);
        }
    });
