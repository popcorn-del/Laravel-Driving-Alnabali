                        ...
                        <form id="custom-form" class="custom-validation" method= "POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                            <div class = "mb-3">
                                                <span class = "font-size-16 text-uppercase" id="cityAdd"> {{__('Add Bus Type')}}</span>
                                                <span class = "font-size-16 text-uppercase" style="display:none" id="cityView"> {{__('View Bus Type')}}</span>
                                                <span class = "font-size-16 text-uppercase" style="display:none" id="cityEdit"> {{__('Edit Bus Type')}}</span>
                                            </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100 datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <button type="button" class="btn btn-outline-warning btn-sm btn-rounded waves-effect waves-light edit busedit" data-id="{{$row->id}}" onclick="edit({{$row->id}})">{{__('edit')}}</button>
