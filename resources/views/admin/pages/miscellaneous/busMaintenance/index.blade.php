                        ...
                        <form id="custom-form" class="custom-validation" method= "POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class = "mb-3">
                                            <span class = "font-size-16 text-uppercase" id="cityAdd"> {{__('Add Maintenance Type')}}</span>
                                            <span class = "font-size-16 text-uppercase" style="display:none" id="cityView"> {{__('View Maintenance Type')}}</span>
                                            <span class = "font-size-16 text-uppercase" style="display:none" id="cityEdit"> {{__('Edit Maintenance Type')}}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label"><span class="custom-val-color span-validation">*</span> {{__('type (en)')}}</label>
                                                <input type="text" class="form-control" minlength="1" maxlength="100" id = "maintenaceTyesEn" name="name_en" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" minlength="1" maxlength="100" id = "maintenaceTyesAr" name="name_ar" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <button type="button" class="btn btn-outline-warning btn-sm btn-rounded waves-effect waves-light edit btn-view" data-id="{{$row->id}}" id="viewbtn" onclick="view({{$row->id}})">{{__('view')}}</button>
                                        <button type="button" class="btn btn-outline-warning btn-sm btn-rounded waves-effect waves-light edit maintenanceTypeEdit" data-id="{{$row->id}}" onclick="edit({{$row->id}})">{{__('edit')}}</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".add-new").on('click', function() {
                ...
                document.getElementById("maintenaceTyesAr").disabled = false;
                document.getElementById("maintenaceTyesEn").disabled = false;
            ...
            $(".maintenanceTypeEdit").on('click', function() {
                clearValidation();
                $("#cityView").css("display","none")
                $("#cityAdd").css("display","none")
