...
@section('page-title') {{__('Trips Report By Contract Type')}} @endsection
@section('css')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-filter">
                            <div class = "row mb-5">
                                <div class = "col-md-2">
                                    <label for="" style="float: left">{{__('contract type')}}</label>
                                    <select class="form-select" name="client_filter" id="contract_type">
                                        <option value="">All Contract Types</option>
                                            @foreach($contracttype_data as $key=>$row)
                                                <option value="{{$row->type_name_en}}">{{$row->type_name_en}}</option>
                                            @endforeach
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#contract_type").change(() => {
                search_strings[0] = $("#contract_type").val();
                filterData();
            });
            // $("#startdate").change(() => {
            //     search_strings[1] = $("#startdate").val();
            //     filterData();
            // })
            // $("#enddate").change(() => {
            //     search_strings[2] = $("#enddate").val();
            //     filterData();
            // })
            function filterData() {
