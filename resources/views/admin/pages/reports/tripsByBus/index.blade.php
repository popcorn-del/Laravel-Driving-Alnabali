...
@section('page-title') {{__('Trips Report By Bus')}} @endsection
@section('css')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-filter">
                            <div class = "row mb-5">
                                <div class = "col-md-2">
                                    <label for="" style="float: left">{{__('bus')}}</label>
                                    <select class="form-select" id="bus_filter" name="bus_filter" style = "margin-top: 0.23rem">
                                        <option value="">All Buses</option>
                                            @foreach($bus_data as $key=>$row)
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#bus_filter").change(() => {
                search_strings[0] = $("#bus_filter").val();
                filterData();
            });
            // $("#startdate").change(() => {
                    ...
                    for (var i = 0; i < search_strings.length; i++) {
                        if (search_strings[i] != '') {
                            if (i == 1 && new Date(data[1]) < new Date(search_strings[1])) {
                                ...
                                return false;
                            } else if((i != 1 && i != 2) && data[i] != search_strings[i]) {
                                return false;
                            }
                        }
                    }
