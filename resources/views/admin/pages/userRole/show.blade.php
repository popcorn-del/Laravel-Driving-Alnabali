...
@section('title') View User Role @endsection
@section('page-title') {{__("view user role")}} @endsection
@section('css')
                    ...
                    <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" minlength="1" maxlength="100" name="name_en" value="{{$user_role->name_en}}" disabled >
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name_ar" minlength="1" maxlength="100" value="{{$user_role->name_ar}}" disabled>
                                    </div>
                                </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-6 add-new-form">
                                        <label class="form-label col-md-12">     {{__('permissions')}}
                                        <div class = "row border rounded border-secondary daysofweek"  id="daysofweek">
                                                <div class = "trip-frequency-check">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-check form-check-warning">
                                                                <input class="form-check-input" type="checkbox" id="select_all" <?php if(count($role_permissions) == count($permissions)) echo "checked" ?> disabled/>
                                                    ...
                                                    @foreach($permissions as $row)
                                                        <div class="col-md-3 form-check-user-role form-check-warning">
                                                            <input class="form-check-input"   type="checkbox" id="permission_{{$row->id}}" name="permission[]"
                                                                value = "{{$row->id}}" {{ in_array($row->id, $role_permissions)? "checked":"" }} disabled>
